...
Use the `ngb3` to add components to your Angular project:
...
npx @ngb3/ui@latest add button
npx @ngb3/ui@latest add button card dialog

# Add all components
npx @ngb3/ui@latest add --all
```
...
Initialize your project and install dependencies for b3-design-system components.
...
```bash
npx @ngb3/ui@latest add [components...]
```
...
npx @ngb3/ui@latest add button card badge

# Add all components
npx @ngb3/ui@latest add --all

# Interactive selection
npx @ngb3/ui@latest add
```
...
```typescript
import { B3ButtonComponent } from '@shared/components/button';
import { mergeClasses } from '@shared/utils/merge-classes';
```

## Tailwind CSS v4 Support

b3-design-system CLI is built specifically for Tailwind CSS v4, using the new inline configuration approach:
...
Run `npx @ngb3/ui@latest init` first to initialize your project.
...
This CLI is part of the [b3-design-system](https://github.com/b3-ui/b3-design-system) project. Please refer to the main repository for contribution guidelines.

## License

MIT © b3-design-system