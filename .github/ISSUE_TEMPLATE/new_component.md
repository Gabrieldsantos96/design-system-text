---
name: '🚀 New Component'
about: 'Suggest a new component for B3 UI'
...
**Philosophy**: <!-- One sentence about how this follows b3-design-system patterns -->
...
<b3-component [prop]="value">
  Content
</b3-component>

<!-- With customization -->
<b3-component [prop]="value" [template]="customTpl">
  Content
</b3-component>
