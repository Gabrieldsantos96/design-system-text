...
const componentsPath = path.resolve(__dirname, '../libs/b3/src/lib/components');
...
function generateCliAddComponentMarkdown(componentName: string): string {
  return `\`\`\`bash tab="npm" copyButton
npx @ngb3/ui add ${componentName}
\`\`\`

\`\`\`bash tab="pnpm"
pnpm dlx @ngb3/ui add ${componentName}
\`\`\`

\`\`\`bash tab="yarn"
yarn dlx @ngb3/ui add ${componentName}
\`\`\`

\`\`\`bash tab="bun"
bunx @ngb3/ui add ${componentName}
\`\`\``;
}
