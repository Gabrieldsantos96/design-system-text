# 🤝 Contributing to b3-design-system

Thank you for your interest in contributing to b3-design-system! This guide will help you understand how the project is structured and how you can contribute effectively.
...
1. **Fork and clone the repository**:
   ...
   ```bash
   git clone https://github.com/[your-username]/b3-design-system.git
   cd b3-design-system
   ```
...
1. **Create component** in `libs/b3/src/lib/components/[name]/`
2. **Implement variants** with CVA in `[component].variants.ts`
3. **Write tests** in `[component].spec.ts`
4. **Add to barrel export** in `libs/b3/src/lib/components/components.ts`
...
- `libs/b3/src/lib/components/*/demo/` → `apps/web/public/components/*/demo/`
- `libs/b3/src/lib/components/*/doc/` → `apps/web/public/components/*/doc/`
...
export const DefaultExample = {
  name: 'Default',
  code: `<b3-button>Click me</b3-button>`,
