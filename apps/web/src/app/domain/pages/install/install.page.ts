...
import { StepsComponent } from '@b3/domain/components/steps/steps.component';
import { Installation, installations } from '@b3/shared/constants/install.constant';
  ...
  setPageTitle() {
    ...
    if (environmentName) {
      this.seoService.setDocsSeo(
        `${environmentName}`,
        `Learn how to install and set up B3 UI in your ${environmentName} project. Step-by-step guide with CLI and manual installation options.`,
