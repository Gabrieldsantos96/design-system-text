...
import { AiAssistComponent } from '@b3/domain/components/ai-assist/ai-assist.component';
...
import { B3CodeBoxComponent } from '../../../widget/components/zard-code-box/zard-code-box.component';
...
@Component({
  selector: 'b3-component',
  templateUrl: './component.page.html',
  standalone: true,
  imports: [DocContentComponent, StepsComponent, B3CodeBoxComponent, ScrollSpyDirective, ScrollSpyItemDirective, MarkdownRendererComponent, AiAssistComponent],
})
