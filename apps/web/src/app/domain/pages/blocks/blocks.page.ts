...
import { CategoryTabsComponent, type CategoryTab } from '@b3/shared/components/category-tabs/category-tabs.component';
...
@Component({
  selector: 'b3-blocks',
  standalone: true,
  imports: [BlockContainerComponent, RouterLink, B3BreadcrumbModule, CategoryTabsComponent],
