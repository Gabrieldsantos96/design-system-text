...
@Component({
  selector: 'b3-json-tailwind-section',
  standalone: true,
    ...
    <section class="flex flex-col gap-8 sm:gap-10" scrollSpyItem="tailwind" id="tailwind">
      <div class="flex flex-col gap-4 sm:gap-6">
        ...
        <div class="flex flex-col gap-3">
          ...
          <p class="text-sm sm:text-base text-muted-foreground leading-relaxed">
            <strong>Important</strong>: B3/ui only supports <strong>Tailwind CSS v4</strong> and <strong>does not support Tailwind CSS v3</strong> or <strong>SCSS</strong>.
          </p>
        </div>
      </div>
      ...
      <div class="flex flex-col gap-8 sm:gap-10">
        <div id="tailwind-css" class="scroll-mt-20 flex flex-col gap-4">
          ...
          <b3-markdown-renderer markdownUrl="documentation/json/tailwind-css-example.md"></b3-markdown-renderer>
        </div>
        ...
        <div id="tailwind-basecolor" class="scroll-mt-20 flex flex-col gap-4">
          ...
          <b3-markdown-renderer markdownUrl="documentation/json/tailwind-basecolor-example.md"></b3-markdown-renderer>
        </div>
        ...
        <div id="tailwind-cssvariables" class="scroll-mt-20 flex flex-col gap-4">
          ...
          <b3-markdown-renderer markdownUrl="documentation/json/tailwind-cssvariables-example.md"></b3-markdown-renderer>
