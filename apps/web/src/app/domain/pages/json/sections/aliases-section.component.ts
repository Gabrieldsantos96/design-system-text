...
@Component({
  selector: 'b3-json-aliases-section',
  standalone: true,
    ...
    <section class="flex flex-col gap-8 sm:gap-10" scrollSpyItem="aliases" id="aliases">
      ...
      <div class="flex flex-col gap-8 sm:gap-10">
        <div id="aliases-components" class="scroll-mt-20 flex flex-col gap-4">
          ...
          <b3-markdown-renderer markdownUrl="documentation/json/aliases-components-example.md"></b3-markdown-renderer>
        </div>
        ...
        <div id="aliases-utils" class="scroll-mt-20 flex flex-col gap-4">
          ...
          <b3-markdown-renderer markdownUrl="documentation/json/aliases-utils-example.md"></b3-markdown-renderer>
        </div>
      </div>
    </section>
  `,
