...
import { ResourceCardComponent } from '@b3/domain/components/resource-card/resource-card.component';
import { ScrollSpyItemDirective } from '@b3/domain/directives/scroll-spy-item.directive';
import { ScrollSpyDirective } from '@b3/domain/directives/scroll-spy.directive';
...
export class FigmaPage implements OnInit {
  ...
  ngOnInit(): void {
    this.seoService.setDocsSeo(
      'Figma',
      'Explore Figma design kits and resources for B3 UI. Free and premium options available to streamline your design-to-development workflow.',
      '/docs/figma',
      'og-figma.jpg',
    );
  }
