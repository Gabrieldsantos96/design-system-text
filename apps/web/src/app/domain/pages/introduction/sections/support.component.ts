        ...
        <div class="relative b3-10">
          <div class="flex flex-col items-center text-center gap-4">
            ...
            <p class="text-base leading-7 text-muted-foreground max-w-2xl">
              Love what we're building? Support B3UI through contributions, sponsorships, or simply spreading the word. Every bit helps us maintain our commitment to the community.
            </p>
            <div class="flex gap-3">
              <a b3-button target="_blank" href="https://github.com/zard-ui/zardui">
                <img src="/icons/github.svg" alt="github icon" class="invert dark:invert-0 hidden md:block h-4 w-4" />
                Star on GitHub
              </a>
              <a b3-button zType="outline" target="_blank" href="https://github.com/sponsors/zard-ui">Be a Sponsor </a>
            </div>
          </div>
        </div>
      </div>
