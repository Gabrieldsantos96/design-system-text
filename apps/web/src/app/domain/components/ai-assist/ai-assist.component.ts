...
import { B3PopoverComponent, B3PopoverDirective } from '@b3/components/popover/popover.component';
...
@Component({
  ...
  imports: [RouterLink, B3PopoverComponent, B3PopoverDirective, B3DividerComponent, B3ButtonComponent, LucideAngularModule],
...
export class AiAssistComponent {
  ...
  private buildAiUrl(provider: 'chatgpt' | 'claude', currentUrl: string): string {
    const message = encodeURIComponent(
      `I'm looking at this B3UI documentation: ${currentUrl}.\nHelp me understand how to use it. Be ready to explain concepts, give examples, or help debug based on it.\n  `,
    );
