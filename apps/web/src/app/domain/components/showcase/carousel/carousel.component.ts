...
export class B3CarouselComponent implements OnInit, AfterViewInit {
  ...
  readonly carouselItems = contentChildren(B3CarouselItemComponent);
...
@Component({
  selector: 'b3-carousel-item',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { '[class]': 'classes()' },
  template: `<ng-content></ng-content>`,
})
export class B3CarouselItemComponent {
  readonly class = input<string>('');
