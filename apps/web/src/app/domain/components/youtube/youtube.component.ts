      ...
      <div class="max-w-5xl mx-auto">
        <header class="text-center mb-16">
          <div class="animate-in fade-in slide-in-from-bottom-3 duration-700">
            ...
            <p class="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">Watch how B3UI is revolutionizing Angular component development</p>
          </div>
        </header>
        ...
        <footer class="text-center mt-12">
          <div class="animate-in fade-in slide-in-from-bottom-3 duration-700 delay-500">
            <p class="text-muted-foreground">See B3UI in action and learn how to get started</p>
          </div>
        </footer>
      </div>
    </section>
...
export class YoutubeComponent {
  readonly videos: YoutubeVideo[] = [
    {
      id: 'o4Xjn-EZ1Lo',
      title: 'B3UI - The Angular Component Library',
    },
    {
      id: 'v1rEaS_1TN4',
      title: 'B3UI Tutorial - Getting Started',
      timestamp: 2695,
    },
    {
      id: 'pHkQ0PhPa4o',
      title: 'Building Modern UIs with B3UI',
    },
    {
      id: '6Oy2FaFjeFM',
      title: 'B3UI Components Showcase',
    },
    {
      id: 'fIKnUsd1tAA',
      title: 'Advanced B3UI Features',
    },
    {
      id: 'MXGZZQK_thk',
      title: 'B3UI Best Practices',
    },
    {
      id: 'zKUhEOdW7Zw',
      title: 'B3UI Video',
