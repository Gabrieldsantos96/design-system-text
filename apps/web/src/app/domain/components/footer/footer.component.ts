...
import { SOCIAL_MEDIAS } from '@b3/shared/constants/medias.constant';
...
@Component({
  ...
  imports: [RouterModule, B3ButtonComponent, B3DividerComponent],
  template: `
    <footer class="mt-24 border-t bg-background">
      <div class="container mx-auto px-4 py-16">
              ...
              <div class="space-y-3">
                <div class="flex items-center space-x-2">
                  <div class="w-8 h-8 bg-gradient-to-br from-primary to-primary/80 rounded-lg flex items-center justify-center p-1">
                    <img src="/images/zard.svg" alt="B3UI Logo" class="w-full h-full object-contain fill-primary-foreground brightness-0 invert dark:invert-0" loading="lazy" />
                  </div>
                  <h3 class="text-xl font-bold bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent">B3UI</h3>
                </div>
        ...
        <div class="mt-16 pt-4">
          <b3-divider class="mb-8"></b3-divider>
