...
@Component({
  ...
  template: `
    <section class="relative overflow-hidden p-5 md:p-0">
      ...
      <div class="relative b3-10 container mx-auto px-4 min-h-[90vh] flex items-center justify-center">
        <div class="max-w-4xl mx-auto text-center space-y-8">
          ...
          <b3-badge zType="secondary" class="text-sm px-4 py-1"> Style of &#64;shadcn/ui + power of ng-zorro = &#64;zard/ui ❤️ </b3-badge>
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a b3-button zType="outline" routerLink="/docs/installation" class="px-8 py-3"> Get Started </a>
          </div>
