...
export class InstallPage {
  ...
  setPageTitle() {
    ...
    this.seoService.setDocsSeo(
      ...
      'Learn how to install B3 UI in your Angular project...',
...
```json
{
  ...
  "description": "Learn how to install B3 UI...",
  "author": {
    "@type": "Person",
    "name": "Luiz Gomes"
  },
...
```typescript
import { JsonLdService } from '@b3/shared/services/json-ld.service';
import { Component, inject, OnInit } from '@angular/core';

@Component({
  selector: 'b3-custom-page',
  template: `...`
})
