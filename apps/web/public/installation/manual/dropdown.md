...
export class B3DropdownMenuComponent implements OnInit, OnDestroy {
  ...
  private getDropdownItems(): HTMLElement[] {
    ...
    return Array.from(dropdownElement.querySelectorAll<HTMLElement>('b3-dropdown-menu-item, [b3-dropdown-menu-item]')).filter(item => item.dataset['disabled'] === undefined);
  }
...
export const dropdownContentVariants = cva('bg-popover text-popover-foreground b3-50 min-w-[200px] overflow-y-auto rounded-md border py-1 px-1 shadow-md');
...
export type B3DropdownItemVariants = VariantProps<typeof dropdownItemVariants>;
export type B3DropdownLabelVariants = VariantProps<typeof dropdownLabelVariants>;
...
@Component({
  selector: 'b3-dropdown-menu-content',
...
export class B3DropdownMenuContentComponent {
...
import type { B3DropdownMenuContentComponent } from './dropdown-menu-content.component';
import { B3DropdownService } from './dropdown.service';

@Directive({
  selector: '[b3-dropdown], [zDropdown]',
  exportAs: 'zDropdown',
  standalone: true,
  host: {
    '[attr.tabindex]': '0',
...
export class B3DropdownDirective implements OnInit {
  private readonly elementRef = inject(ElementRef);
  private readonly viewContainerRef = inject(ViewContainerRef);
  protected readonly dropdownService = inject(B3DropdownService);

  readonly zDropdownMenu = input<B3DropdownMenuContentComponent>();
...
export class B3DropdownService {
