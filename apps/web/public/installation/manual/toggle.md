...
import { toggleVariants, type B3ToggleVariants } from './toggle.variants';
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => B3ToggleComponent),
      multi: true,
    },
  ],
})
export class B3ToggleComponent implements ControlValueAccessor {
  ...
  readonly zType = input<B3ToggleVariants['zType']>('default');
  readonly zSize = input<B3ToggleVariants['zSize']>('md');
...
export type B3ToggleVariants = VariantProps<typeof toggleVariants>;
