  ...
  template: `
    ...
    >
      ...
      <div [class]="inputWrapperClasses()">
        ...
        <ng-content select="input[b3-input], textarea[b3-input]"></ng-content>
...
export class B3InputGroupComponent {
  readonly zSize = input<B3InputGroupVariants['zSize']>('default');
...
export const inputGroupVariants = cva(
  'flex items-stretch w-full [&_input[b3-input]]:!border-0 [&_input[b3-input]]:!bg-transparent [&_input[b3-input]]:!outline-none [&_input[b3-input]]:!ring-0 [&_input[b3-input]]:!ring-offset-0 [&_input[b3-input]]:!px-0 [&_input[b3-input]]:!py-0 [&_input[b3-input]]:!h-full [&_input[b3-input]]:flex-1 [&_textarea[b3-input]]:!border-0 [&_textarea[b3-input]]:!bg-transparent [&_textarea[b3-input]]:!outline-none [&_textarea[b3-input]]:!ring-0 [&_textarea[b3-input]]:!ring-offset-0 [&_textarea[b3-input]]:!px-0 [&_textarea[b3-input]]:!py-0',
  {
    variants: {
      zSize: {
        sm: 'h-9',
...
export const inputGroupAffixVariants = cva('absolute inset-y-0 flex items-center text-muted-foreground pointer-events-none b3-10', {
  variants: {
    zSize: {
      sm: 'text-xs',
      default: 'text-sm',
...
export type B3InputGroupVariants = VariantProps<typeof inputGroupVariants>;
...
export { B3InputGroupComponent } from './input-group.component';
