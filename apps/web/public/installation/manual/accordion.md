...
export class B3AccordionComponent implements AfterContentInit {
  readonly items = contentChildren(B3AccordionItemComponent);
  ...
  toggleItem(selectedItem: B3AccordionItemComponent): void {
...
export type B3AccordionVariants = VariantProps<typeof accordionVariants>;
export type B3AccordionItemVariants = VariantProps<typeof accordionItemVariants>;
export type B3AccordionTriggerVariants = VariantProps<typeof accordionTriggerVariants>;
export type B3AccordionContentVariants = VariantProps<typeof accordionContentVariants>;
...
import type { B3AccordionComponent } from './accordion.component';
...
export class B3AccordionItemComponent {
  ...
  accordion?: B3AccordionComponent;
