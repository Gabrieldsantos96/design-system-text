...
export class B3PopoverDirective implements OnInit, OnDestroy {
  ...
  readonly zTrigger = input<B3PopoverTrigger>('click');
  readonly zContent = input.required<TemplateRef<unknown>>();
  readonly zPlacement = input<B3PopoverPlacement>('bottom');
...
export class B3PopoverComponent {
