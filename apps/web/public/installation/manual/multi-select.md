...
```angular-ts title="multi-select.component.ts" expandable="true" expandableTitle="Expand" copyButton showLineNumbers
...
```angular-ts title="multi-select.variants.ts" expandable="true" expandableTitle="Expand" copyButton showLineNumbers
