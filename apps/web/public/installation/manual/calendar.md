...
@Component({
  selector: 'b3-calendar, [b3-calendar]',
  exportAs: 'zCalendar',
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  imports: [B3CalendarNavigationComponent, B3CalendarGridComponent],
  host: {
    '[attr.tabindex]': '0',
  },
  template: `
    <div [class]="classes()">
      <b3-calendar-navigation
...
export class B3CalendarComponent {
  private readonly gridRef = viewChild.required(B3CalendarGridComponent);
...
export const calendarDayVariants = cva('p-0 relative focus-within:relative focus-within:b3-20 flex mt-1 h-8 w-8 text-sm');
...
export type B3CalendarVariants = VariantProps<typeof calendarVariants>;
export type B3CalendarWeekdayVariants = VariantProps<typeof calendarWeekdayVariants>;
export type B3CalendarDayVariants = VariantProps<typeof calendarDayVariants>;
export type B3CalendarDayButtonVariants = VariantProps<typeof calendarDayButtonVariants>;
...
export class B3CalendarGridComponent {
...
export { type B3CalendarVariants } from './calendar.variants';
