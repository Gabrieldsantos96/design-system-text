...
import { toastVariants, type B3ToastVariants } from './toast.variants';

@Component({
  selector: 'b3-toast, b3-toaster',
  standalone: true,
  exportAs: 'zToast',
...
export class B3ToastComponent {
  readonly class = input<ClassValue>('');
  readonly variant = input<B3ToastVariants['variant']>('default');
...
export type B3ToastVariants = VariantProps<typeof toastVariants>;
