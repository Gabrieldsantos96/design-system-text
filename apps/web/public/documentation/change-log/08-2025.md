...
August marked the foundation of the B3UI CLI with the first releases and core architecture.
...
```bash
npm install @ngb3/ui@1.0.0-beta.2
```
...
Implemented a **core directive system** that provides better code organization, cleaner separation of concerns, and enhanced maintainability for all B3UI components.
