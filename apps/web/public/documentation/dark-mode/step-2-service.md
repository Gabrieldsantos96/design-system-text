...
## Alternative: Copy from B3UI

You can also copy the service directly from the B3UI project:

```bash
cp node_modules/@b3/services/darkmode.service.ts src/app/services/
```
