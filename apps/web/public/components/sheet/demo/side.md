...
export class B3DemoSheetSideInputComponent {
...
@Component({
  standalone: true,
  imports: [B3RadioComponent, FormsModule, B3ButtonComponent, B3SheetModule],
  template: `
    <div class="space-y-6 flex flex-col justify-center">
      <div class="flex space-x-4">
        <span b3-radio name="top" [(ngModel)]="placement" value="top">top</span>
        <span b3-radio name="bottom" [(ngModel)]="placement" value="bottom">bottom</span>
        <span b3-radio name="left" [(ngModel)]="placement" value="left">left</span>
        <span b3-radio name="right" [(ngModel)]="placement" value="right">right</span>
      </div>
      <button b3-button zType="outline" (click)="openSheet()">Edit profile</button>
    </div>
  `,
})
export class B3DemoSheetSideComponent {
  ...
  openSheet() {
    this.sheetService.create({
      ...
      zContent: B3DemoSheetSideInputComponent,
      zData: {
