...
export class B3DemoSheetBasicInputComponent {
...
@Component({
  standalone: true,
  imports: [B3ButtonComponent, B3SheetModule],
  template: ` <button b3-button zType="outline" (click)="openSheet()">Edit profile</button> `,
})
export class B3DemoSheetBasicComponent {
  ...
  openSheet() {
    this.sheetService.create({
      ...
      zContent: B3DemoSheetBasicInputComponent,
      zData: {
