...
import { B3CardComponent } from '../card.component';

@Component({
  selector: 'b3-demo-card-default',
  standalone: true,
  imports: [B3CardComponent, B3ButtonComponent],
  template: `
    <b3-card class="w-full max-w-sm" zTitle="Login to your account" zDescription="Enter your email below to login to your account">
      <div class="space-y-4">
        <div class="space-y-2">
        ...
        <div class="space-y-2">
          <b3-button zType="default" class="w-full">Login</b3-button>
          <b3-button zType="outline" class="w-full">Login with Google</b3-button>
        </div>
      </div>
    </b3-card>
  `,
})
export class B3DemoCardDefaultComponent {
