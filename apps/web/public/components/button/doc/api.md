...
## [b3-button] <span class="api-type-label directive">Directive</span>

> b3-button is a Directive, it accepts all props which are supported by [native button](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/button).
