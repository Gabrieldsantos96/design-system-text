...
## `<b3-progress-bar>` <span class="api-type-label component">Component</span>

The `b3-progress-bar` component is a flexible and customizable progress bar that allows full styling control using class-variance-authority (CVA). It provides several configuration options for size, shape, type, and more.
