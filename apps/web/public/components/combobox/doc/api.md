...
| `options`           | `B3ComboboxOption[]`                             | `[]`                  | Array of options (for flat list)            |
| `groups`            | `B3ComboboxGroup[]`                              | `[]`                  | Array of grouped options                    |
...
| `zOnSelect`    | `EventEmitter<B3ComboboxOption>` | Emitted when an option is selected |
