...
@Component({
  selector: 'b3-demo-layout-theme',
  standalone: true,
  imports: [LayoutComponent, HeaderComponent, ContentComponent, SidebarComponent],
  template: `
    <div class="flex gap-4">
      <!-- Light Theme -->
      <b3-layout class="flex-1 min-h-[400px] rounded-lg overflow-hidden border">
        <b3-sidebar zTheme="light" [zWidth]="180">
          <div class="p-4">
      ...
      <!-- Dark Theme -->
      <b3-layout class="flex-1 min-h-[400px] rounded-lg overflow-hidden border">
        <b3-sidebar zTheme="dark" [zWidth]="180">
          <div class="p-4">
