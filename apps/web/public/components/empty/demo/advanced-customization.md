...
@Component({
  ...
  template: `
    <b3-empty [zImage]="customImage" [zTitle]="customTitle" zDescription="Invite your team to get started" [zActions]="[actionInvite]"> </b3-empty>
...
export class B3DemoEmptyAdvancedCustomizationComponent {}
