...
@Component({
  selector: 'b3-demo-input-group-borderless',
  standalone: true,
  imports: [B3InputGroupComponent, B3InputDirective],
  template: `
    <div class="flex flex-col space-y-4">
      <b3-input-group zPrefix="$" zSuffix="USD" zBorderless>
        <input b3-input placeholder="0.00" type="number" />
      </b3-input-group>

      <b3-input-group zAddOnBefore="https://" zAddOnAfter=".com" zBorderless>
        <input b3-input placeholder="example" />
      </b3-input-group>

      <b3-input-group zAddOnBefore="@" zBorderless>
        <input b3-input placeholder="username" />
      </b3-input-group>
    </div>
  `,
})
export class B3DemoInputGroupBorderlessComponent {}
