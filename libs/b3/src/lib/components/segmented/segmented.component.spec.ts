...
import { SegmentedOption, B3SegmentedComponent, B3SegmentedItemComponent } from './segmented.component';

@Component({
  template: ` <b3-segmented [zOptions]="options" [zDefaultValue]="defaultValue" [zDisabled]="disabled" (zChange)="onSelectionChange($event)"></b3-segmented> `,
  standalone: true,
...
@Component({
  template: `
    <b3-segmented>
      <b3-segmented-item value="item1" label="Item 1"></b3-segmented-item>
      <b3-segmented-item value="item2" label="Item 2"></b3-segmented-item>
      <b3-segmented-item value="item3" label="Item 3" [disabled]="true"></b3-segmented-item>
    </b3-segmented>
  `,
  standalone: true,
  imports: [B3SegmentedComponent, B3SegmentedItemComponent],
})
class TestContentProjectionComponent {}

describe('B3SegmentedComponent', () => {
  let component: B3SegmentedComponent;
  let fixture: ComponentFixture<B3SegmentedComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(B3SegmentedComponent);
...
describe('B3SegmentedComponent with TestHost', () => {
...
describe('B3SegmentedComponent with Content Projection', () => {
...
describe('B3SegmentedItemComponent', () => {
  let component: B3SegmentedItemComponent;
  let fixture: ComponentFixture<B3SegmentedItemComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [B3SegmentedItemComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(B3SegmentedItemComponent);
    component = fixture.componentInstance;
  });
