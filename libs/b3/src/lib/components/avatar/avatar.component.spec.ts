...
import { B3AvatarComponent, B3AvatarStatus } from './avatar.component';
import { B3AvatarVariants, B3ImageVariants } from './avatar.variants';

@Component({
  standalone: true,
  imports: [B3AvatarComponent],
  template: ` <b3-avatar [zSize]="zSize" [zShape]="zShape" [zStatus]="zStatus" [zSrc]="zSrc" [zAlt]="zAlt" [zFallback]="zFallback" [class]="customClass"> </b3avatar> `,
})
class TestHostComponent {
  zSize: B3AvatarVariants['zSize'] = 'default';
  zShape: B3ImageVariants['zShape'] = 'circle';
  zStatus: B3AvatarStatus | null = null;
...
describe('B3AvatarComponent', () => {
  let hostComponent: TestHostComponent;
  let avatarComponent: B3AvatarComponent;
  ...
  beforeEach(async () => {
    ...
    const avatarDebugElement = fixture.debugElement.query(By.directive(B3AvatarComponent));
  ...
  describe('Variant inputs', () => {
    ...
    it('should apply correct classes based on variants', () => {
      ...
      const avatarElement = fixture.debugElement.query(By.directive(B3AvatarComponent)).nativeElement;
