...
@Component({
  ...
  `,
  standalone: true,
  imports: [B3PopoverDirective, B3PopoverComponent],
})
class TestComponent {
...
describe('B3PopoverComponent', () => {
  ...
  it('should have flexible positioning with multiple fallback positions', () => {
    ...
    const directive = buttonElement.injector.get(B3PopoverDirective);
...
describe('B3PopoverComponent standalone', () => {
  let component: B3PopoverComponent;
  let fixture: ComponentFixture<B3PopoverComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [B3PopoverComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(B3PopoverComponent);
    component = fixture.componentInstance;
    fixture.detectChanges();
  });
...
describe('B3PopoverComponent with hover trigger', () => {
