...
## [b3-toaster] <span class="api-type-label component">Component</span>

> `b3-toaster` is a component that displays toast notifications. It uses `ngx-sonner` under the hood.
