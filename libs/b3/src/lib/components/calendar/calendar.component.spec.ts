...
import { B3CalendarComponent, CalendarDay } from './calendar.component';
import { isSameDay, isDateDisabled, getDayAriaLabel, generateCalendarDays } from './calendar.utils';

describe('B3CalendarComponent', () => {
  let component: B3CalendarComponent;
  let fixture: ComponentFixture<B3CalendarComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(B3CalendarComponent);
