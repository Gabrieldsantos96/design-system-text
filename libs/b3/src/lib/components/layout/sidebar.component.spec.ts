...
describe('SidebarComponent', () => {
  ...
  it('should display correct chevron icon when not collapsed', () => {
    ...
    const iconElement = fixture.debugElement.query(By.css('b3-icon'));
  ...
  it('should use custom trigger template when provided', () => {
    @Component({
      ...
      imports: [SidebarComponent],
      template: `
        <b3-sidebar [zCollapsible]="true" [zTrigger]="customTrigger">
  ...
  it('should render ng-content', () => {
    @Component({
      standalone: true,
      imports: [SidebarComponent],
      template: `<b3-sidebar>Test Sidebar Content</b3-sidebar>`,
    })
    class TestHostComponent {}
...
describe('SidebarGroupComponent', () => {
  ...
  it('should render ng-content', () => {
    @Component({
      standalone: true,
      imports: [SidebarGroupComponent],
      template: `<b3-sidebar-group>Group Content</b3-sidebar-group>`,
    })
    class TestHostComponent {}
...
describe('SidebarGroupLabelComponent', () => {
  ...
  it('should render ng-content', () => {
    @Component({
      standalone: true,
      imports: [SidebarGroupLabelComponent],
      template: `<b3-sidebar-group-label>Label Text</b3-sidebar-group-label>`,
    })
    class TestHostComponent {}
