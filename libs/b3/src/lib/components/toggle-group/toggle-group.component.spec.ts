...
import { B3ToggleGroupComponent, B3ToggleGroupItem } from './toggle-group.component';

describe('B3ToggleGroupComponent', () => {
  let component: B3ToggleGroupComponent;
  let fixture: ComponentFixture<B3ToggleGroupComponent>;

  const mockToggleItems: B3ToggleGroupItem[] = [
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [B3ToggleGroupComponent, ReactiveFormsModule],
    }).compileComponents();

    fixture = TestBed.createComponent(B3ToggleGroupComponent);
  ...
  it('should render icons when provided', () => {
    const itemsWithIcons: B3ToggleGroupItem[] = [
    ...
    const buttons = fixture.nativeElement.querySelectorAll('button');
    const icon1 = buttons[0].querySelector('span[b3-icon]');
    const icon2 = buttons[1].querySelector('span[b3-icon]');
  ...
  it('should render both icon and label when provided', () => {
    const itemsWithIconsAndLabels: B3ToggleGroupItem[] = [{ value: 'bold', icon: 'bold', label: 'Bold', ariaLabel: 'Toggle bold' }];

    fixture.componentRef.setInput('items', itemsWithIconsAndLabels);
    fixture.detectChanges();

    const button = fixture.nativeElement.querySelector('button');
    const icon = button.querySelector('span[b3-icon]');
