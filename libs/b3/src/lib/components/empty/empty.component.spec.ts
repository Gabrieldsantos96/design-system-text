...
@Component({
  template: `
    <b3-empty [zImage]="image" [zDescription]="description" [zSize]="size" [class]="customClass"></b3empty>
...
describe('B3EmptyComponent', () => {
  ...
  it('should create', () => {
    const comp = fixture.debugElement.query(By.directive(B3EmptyComponent));
  ...
  it('should apply small variant classes when zSize="sm"', () => {
    ...
    const comp = fixture.debugElement.query(By.css('b3-empty'));
