...
import { B3AlertDialogComponent } from './alert-dialog.component';
...
describe('B3AlertDialogService', () => {
  let service: B3AlertDialogService;
  let platformId: object;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [B3AlertDialogComponent, NoopAnimationsModule, OverlayModule],
      providers: [B3AlertDialogService],
    }).compileComponents();

    service = TestBed.inject(B3AlertDialogService);
...
describe('B3AlertDialogComponent', () => {
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [B3AlertDialogComponent, NoopAnimationsModule, OverlayModule],
    }).compileComponents();
