...
@Component({
  ...
  template: `
    <b3-toggle aria-label="Test component" [zValue]="zValue" [zDefault]="zDefault" [disabled]="disabled">
      <div b3-icon zType="bold"></div>
    </b3-toggle>
  `,
})
class TestB3ToggleComponent {
  zDefault = false;
  disabled = false;
}

describe('ToggleComponent Integration', () => {
  let fixture: ComponentFixture<TestB3ToggleComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TestB3ToggleComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(TestB3ToggleComponent);
...
describe('should behave correctly when zDisabled="true"', () => {
  let fixture: ComponentFixture<TestB3ToggleComponent>;
  let component: TestB3ToggleComponent;
