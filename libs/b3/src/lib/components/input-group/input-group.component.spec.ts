...
@Component({
  ...
  template: `
    ...
    >
      <input b3-input type="text" placeholder="Test input" />
    </b3-input-group>
  `,
})
...
describe('B3InputGroupComponent', () => {
  let component: B3InputGroupComponent;
  let fixture: ComponentFixture<B3InputGroupComponent>;
  let hostComponent: TestHostComponent;
  let hostFixture: ComponentFixture<TestHostComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [B3InputGroupComponent, B3InputDirective, TestHostComponent],
    }).compileComponents();
  });

  describe('Component Initialization', () => {
    beforeEach(() => {
      fixture = TestBed.createComponent(B3InputGroupComponent);
  ...
  describe('Complex Scenarios', () => {
    ...
    it('should handle input-only scenario', () => {
      ...
      const wrapper = hostFixture.debugElement.nativeElement.querySelector('[role="group"]');
      const inputWrapper = hostFixture.debugElement.nativeElement.querySelector('.relative');
      const input = hostFixture.debugElement.nativeElement.querySelector('input[b3-input]');
...
describe('B3InputDirective', () => {
  let directive: B3InputDirective;
  ...
  beforeEach(async () => {
    ...
    const inputElement = fixture.debugElement.nativeElement.querySelector('input[b3-input]');
    expect(inputElement).toBeTruthy();
  });

  it('should apply correct classes to input element', () => {
    const inputElement = fixture.debugElement.nativeElement.querySelector('input[b3-input]');
    // The input element gets its classes from B3InputDirective
