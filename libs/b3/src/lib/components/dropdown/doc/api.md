...
## b3-dropdown (Directive) <span class="api-type-label directive">Directive</span>
...
| ----------------- | ---------------------------------- | ---------------------------------- | --------- |
| `[zDropdownMenu]` | Reference to dropdown menu content | `B3DropdownMenuContentComponent` | -         |
| `[zTrigger]`      | Trigger type for dropdown          | `'click' \| 'hover'`               | `'click'` |
| `[zDisabled]`     | Disables the dropdown trigger      | `boolean`                          | `false`   |

## b3-dropdown-menu <span class="api-type-label component">Component</span>
...
## b3-dropdown-menu-content <span class="api-type-label component">Component</span>
...
## b3-dropdown-menu-item <span class="api-type-label component">Component</span>
...
## b3-dropdown-menu-label <span class="api-type-label component">Component</span>
...
## b3-dropdown-menu-shortcut <span class="api-type-label component">Component</span>
...
## B3DropdownService <span class="api-type-label service">Service</span>
