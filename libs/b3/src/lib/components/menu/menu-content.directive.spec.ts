...
@Component({
  template: `<div b3-menu-content [class]="customClass">Menu Content</div>`,
  imports: [B3MenuContentDirective],
})
class TestComponent {
  customClass = '';
}

describe('B3MenuContentDirective', () => {
  let component: TestComponent;
  let fixture: ComponentFixture<TestComponent>;
  let directive: B3MenuContentDirective;
  ...
  beforeEach(async () => {
    ...
    const directiveDebugElement = fixture.debugElement.query(By.directive(B3MenuContentDirective));
    directive = directiveDebugElement.injector.get(B3MenuContentDirective);
  ...
  it('should apply default variant classes', () => {
    expect(element.className).toContain('b3-50');
