...
@Component({
  template: `<button b3-menu-item [zDisabled]="disabled" [zInset]="inset" [class]="customClass">Menu Item</button>`,
  imports: [B3MenuItemDirective],
})
class TestComponent {
  disabled = false;
...
describe('B3MenuItemDirective', () => {
  let component: TestComponent;
  let fixture: ComponentFixture<TestComponent>;
  let directive: B3MenuItemDirective;
  ...
  beforeEach(async () => {
    ...
    const directiveDebugElement = fixture.debugElement.query(By.directive(B3MenuItemDirective));
    directive = directiveDebugElement.injector.get(B3MenuItemDirective);
