...
@Component({
  ...
  template: `
    ...
    <span b3-checkbox zType="default">Default Type</span>
    <span b3-checkbox zType="destructive">Destructive</span>

    <span b3-checkbox zSize="default">Default Size</span>
    <span b3-checkbox zSize="lg">Large Size</span>

    <span b3-checkbox zShape="default">Default Shape</span>
    <span b3-checkbox zShape="circle">Circle Shape</span>
    <span b3-checkbox zShape="square">Square Shape</span>
...
@Component({
  standalone: true,
  imports: [B3CheckboxComponent, FormsModule],
  template: ` <span b3-checkbox [(ngModel)]="checked">Checked</span> `,
})
...
@Component({
  standalone: true,
  imports: [B3CheckboxComponent, ReactiveFormsModule],
  template: `
    <form [formGroup]="form">
      <span b3-checkbox formControlName="termsCheckbox"> Agree to Terms </span>
      <span b3-checkbox formControlName="newsletterCheckbox"> Subscribe to Newsletter </span>
      <span b3-checkbox formControlName="privacyCheckbox" [disabled]="form.get('privacyCheckbox')?.disabled"> Accept Privacy Policy </span>
    </form>
  `,
})
...
describe('B3CheckboxComponent', () => {
  ...
  describe('Checked State', () => {
    it('should bind checked property from ngModel', async () => {
      const checkbox = fixtureWithNgModel.debugElement.query(By.directive(B3CheckboxComponent));
      const componentInstance = checkbox.componentInstance as B3CheckboxComponent;
    ...
    it('should update ngModel when checkbox is clicked', async () => {
      const checkboxDe = fixtureWithNgModel.debugElement.query(By.directive(B3CheckboxComponent));
...
describe('B3CheckboxComponent with Reactive Forms', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TestHostWithReactiveFormsComponent, B3CheckboxComponent, ReactiveFormsModule],
    }).compileComponents();
