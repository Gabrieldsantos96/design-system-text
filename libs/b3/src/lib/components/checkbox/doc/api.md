...
## [b3-checkbox] <span class="api-type-label directive">Directive</span>

> b3-checkbox is a Directive that brings you a customizable checkbox with minimal configuration
