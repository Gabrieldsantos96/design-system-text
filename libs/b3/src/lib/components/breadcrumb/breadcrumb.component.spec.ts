...
@Component({
  ...
  standalone: true,
  imports: [B3BreadcrumbComponent, B3BreadcrumbItemComponent, B3BreadcrumbEllipsisComponent],
  template: `
    <b3-breadcrumb>
      <b3-breadcrumb-item [routerLink]="['/']">Home</b3breadcrumb-item>
      <b3-breadcrumb-item>
        <b3-breadcrumb-ellipsis />
      </b3-breadcrumb-item>
      <b3-breadcrumb-item [routerLink]="['/components']">Components</b3-breadcrumb-item>
      <b3-breadcrumb-item>
...
describe('BreadcrumbComponents Integration', () => {
  ...
  it('should render all breadcrumb components', () => {
    expect(fixture.debugElement.query(By.directive(B3BreadcrumbComponent))).toBeTruthy();
    expect(fixture.debugElement.query(By.directive(B3BreadcrumbItemComponent))).toBeTruthy();
    expect(fixture.debugElement.query(By.directive(B3BreadcrumbEllipsisComponent))).toBeTruthy();
  });

  it('should have default classes for B3BreadcrumbComponent', () => {
    const breadcrumDebug = fixture.debugElement.query(By.directive(B3BreadcrumbComponent));
  ...
  it('should have default classes for breadcrumb list (ol element)', () => {
    const breadcrumbDebug = fixture.debugElement.query(By.directive(B3BreadcrumbComponent));
  ...
  it('should have default classes for B3BreadcrumbItemComponent', () => {
    const breadcrumItemDebug = fixture.debugElement.query(By.directive(B3BreadcrumbItemComponent));
  ...
  it('should have default classes for B3BreadcrumbEllipsisComponent', () => {
    const breadcrumDebug = fixture.debugElement.query(By.directive(B3BreadcrumbEllipsisComponent)).nativeElement;
    expect(breadcrumDebug.classList).toContain('flex');
  });

  it('should render projected content correctly', () => {
    const items = fixture.debugElement.queryAll(By.directive(B3BreadcrumbItemComponent));
  ...
  it('breadcrumb-ellipsis should contain b3-icon component', () => {
    const breadcrumbPageDebug = fixture.debugElement.query(By.directive(B3BreadcrumbEllipsisComponent));
    const iconElement = breadcrumbPageDebug.query(By.css('b3-icon'));
  ...
  it('should render default chevron separator when zSeparator is not provided', () => {
    const separator = fixture.debugElement.query(By.css('li[aria-hidden="true"][role="presentation"] b3-icon'));
...
describe('BreadcrumbComponent - Custom Separator', () => {
  @Component({
    ...
    standalone: true,
    imports: [B3BreadcrumbComponent, B3BreadcrumbItemComponent],
    template: `
      <b3-breadcrumb [zSeparator]="separator">
        <b3-breadcrumb-item [routerLink]="['/']">Home</b3-breadcrumb-item>
        <b3-breadcrumb-item [routerLink]="['/docs']">Docs</b3-breadcrumb-item>
        <b3-breadcrumb-item>Current</b3-breadcrumb-item>
      </b3-breadcrumb>
  ...
  it('should render default chevron when zSeparator is null', () => {
    ...
    const chevrons = fixture.debugElement.queryAll(By.css('li[aria-hidden="true"][role="presentation"] b3-icon'));
...
describe('BreadcrumbComponent - Alignment and Wrapping', () => {
  @Component({
    ...
    imports: [B3BreadcrumbComponent, B3BreadcrumbItemComponent],
    template: `
      <b3-breadcrumb [zAlign]="align" [zWrap]="wrap">
        <b3-breadcrumb-item>Home</b3-breadcrumb-item>
        <b3-breadcrumb-item>Docs</b3-breadcrumb-item>
      </b3-breadcrumb>
    `,
  })
...
describe('BreadcrumbEllipsisComponent - Color Variants', () => {
  @Component({
    ...
    template: `
      <b3-breadcrumb>
        <b3-breadcrumb-item>Home</b3-breadcrumb-item>
        <b3-breadcrumb-item>
          <b3-breadcrumb-ellipsis [zColor]="color" />
        </b3-breadcrumb-item>
        <b3-breadcrumb-item>Current</b3-breadcrumb-item>
      </b3-breadcrumb>
    `,
  ...
  it('should apply default color (muted) to ellipsis', () => {
    fixture.detectChanges();
    const ellipsis = fixture.debugElement.query(By.directive(B3BreadcrumbEllipsisComponent)).nativeElement;
