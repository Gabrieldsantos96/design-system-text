...
## [b3-card] <span class="api-type-label component">Component</span>

> b3-card is a component that provides a structured container for displaying content with optional header and body sections.
