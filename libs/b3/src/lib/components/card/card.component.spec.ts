...
describe('B3CardComponent', () => {
  let component: B3CardComponent;
  let fixture: ComponentFixture<B3CardComponent>;
  let debugElement: DebugElement;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [B3CardComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(B3CardComponent);
  ...
  it('should render ng-content in body', () => {
    @Component({
      ...
      standalone: true,
      imports: [B3CardComponent],
      template: `<b3-card>Test Content</b3card>`,
    })
  ...
  it('should support template ref for description', () => {
    @Component({
      ...
      imports: [B3CardComponent],
      template: `
        <b3-card zTitle="Title" [zDescription]="descriptionTemplate">
