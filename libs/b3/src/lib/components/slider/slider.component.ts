  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => B3SliderComponent),
      multi: true,
    },
  ],
  template: `
    ...
    >
      <b3-slider-track [orientation]="zOrientation()">
        <b3-slider-range [orientation]="zOrientation()" [percent]="percentValue()"></b3-slider-range>
      </b3-slider-track>
...
export class B3SliderComponent implements ControlValueAccessor, AfterViewInit, OnChanges, OnDestroy {
