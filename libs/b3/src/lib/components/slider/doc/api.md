...
## [b3-slider] <span class="api-type-label component">Component</span>

> `b3-slider` is a flexible and accessible component that allows users to select a numeric value from within a configurable range using pointer or keyboard interaction.
