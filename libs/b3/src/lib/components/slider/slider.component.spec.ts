...
import { B3SliderComponent, ZSliderRangeComponent, ZSliderThumbComponent, ZSliderTrackComponent } from './slider.component';

@Component({
  selector: 'test-slider-host',
  standalone: true,
  imports: [B3SliderComponent],
  template: ` <b3-slider [zMin]="min" [zMax]="max" [zStep]="step" [zValue]="value" [zOrientation]="orientation" [zDisabled]="disabled" [zDefault]="default"></b3-slider> `,
})
...
describe('B3SliderComponent (orientation: horizontal)', () => {
  ...
  it('should render slider with thumb, track and range', () => {
    expect(fixture.debugElement.query(By.directive(B3SliderComponent))).toBeTruthy();
  ...
  it('should have orientation attribute on host', () => {
    const host = fixture.debugElement.query(By.directive(B3SliderComponent)).nativeElement;
  ...
  it('should respect zDisabled input and reflect as aria-disabled', () => {
    ...
    fixture.detectChanges();
    const compInstance = fixture.debugElement.query(By.directive(B3SliderComponent)).componentInstance;
...
describe('B3SliderComponent (orientation: vertical)', () => {
  let fixture: ComponentFixture<TestHostComponent>;
  let component: TestHostComponent;
