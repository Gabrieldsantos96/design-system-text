...
describe('ButtonComponent', () => {
  it('should create', () => {
    @Component({
      ...
      template: `<button b3-button>Test</button>`,
    })
    class TestComponent {}
  ...
  describe('iconOnly detection', () => {
    it('should set data-icon-only attribute when button has only an icon', async () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button><i b3-icon></i></button>`,
      })
      class TestComponent {}
    ...
    it('should not set data-icon-only when button has text and icon', async () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button>Button <i b3-icon></i></button>`,
      })
      class TestComponent {}
    ...
    it('should not set data-icon-only when button has only text', async () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button>Button</button>`,
      })
      class TestComponent {}
    ...
    it('should not set data-icon-only when button has icon before text', async () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button><i b3-icon></i> Button</button>`,
      })
      class TestComponent {}
  ...
  describe('size variants', () => {
    ...
    it('should apply sm size classes', () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button zSize="sm">Button</button>`,
      })
      class TestComponent {}
    ...
    it('should apply lg size classes', () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button zSize="lg">Button</button>`,
      })
      class TestComponent {}
  ...
  describe('type variants', () => {
    ...
    it('should apply destructive type classes', () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button zType="destructive">Button</button>`,
      })
      class TestComponent {}
    ...
    it('should apply outline type classes', () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button zType="outline">Button</button>`,
      })
      class TestComponent {}
  ...
  describe('loading state', () => {
    it('should render loading icon when zLoading is true', () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button [zLoading]="true">Button</button>`,
      })
      class TestComponent {}
      ...
      const loadingIcon = fixture.nativeElement.querySelector('[b3-icon]');
    ...
    it('should not render loading icon when zLoading is false', () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button [zLoading]="false">Button</button>`,
      })
      class TestComponent {}
  ...
  describe('full width', () => {
    it('should apply w-full class when zFull is true', () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button [zFull]="true">Button</button>`,
      })
      class TestComponent {}
    ...
    it('should not apply w-full class when zFull is false', () => {
      @Component({
        standalone: true,
        imports: [B3ButtonComponent],
        template: `<button b3-button [zFull]="false">Button</button>`,
      })
      class TestComponent {}
