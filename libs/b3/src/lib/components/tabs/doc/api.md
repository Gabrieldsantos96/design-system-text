...
## [b3-tab] <span class="api-type-label component">Component</span>

> b3-tab-group is a Component that allows you to create a tabbed interface with customizable navigation and active indicator positions.
