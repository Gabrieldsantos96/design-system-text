...
@Component({
  ...
  standalone: true,
  imports: [B3CommandOptionGroupComponent],
  template: `
    <b3-command-option-group zLabel="Test Group" class="custom-class">
      <div>Content</div>
    </b3command-option-group>
  `,
})
class TestHostComponent {}

describe('B3CommandOptionGroupComponent', () => {
  let fixture: ComponentFixture<TestHostComponent>;
  let component: B3CommandOptionGroupComponent;

  beforeEach(async () => {
    fixture = TestBed.createComponent(TestHostComponent);
    component = fixture.debugElement.query(By.directive(B3CommandOptionGroupComponent)).componentInstance;
