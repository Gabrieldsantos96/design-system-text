...
## [b3-command] <span class="api-type-label component">Component</span>
...
| ----------- | -------------------------------------- | --------------------------------- |
| `zOnChange` | Fired when the selected option changes | `EventEmitter<B3CommandOption>` |
| `zOnSelect` | Fired when an option is selected       | `EventEmitter<B3CommandOption>` |

---

## [b3-command-input] <span class="api-type-label component">Component</span>
...
## [b3-command-list] <span class="api-type-label component">Component</span>
...
## [b3-command-empty] <span class="api-type-label component">Component</span>
...
## [b3-command-option] <span class="api-type-label component">Component</span>
...
## [b3-command-option-group] <span class="api-type-label component">Component</span>
...
## [b3-command-divider] <span class="api-type-label component">Component</span>
