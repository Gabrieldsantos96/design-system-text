...
@Component({
  ...
  standalone: true,
  imports: [B3CommandOptionComponent],
  template: ` <b3-command-option zLabel="Test Option" zValue="test-value" zShortcut="⌘K" zIcon="search" [zDisabled]="disabled" variant="default"> </b3command-option> `,
})
class TestHostComponent {
  disabled = false;
}

describe('B3CommandOptionComponent', () => {
  let fixture: ComponentFixture<TestHostComponent>;
  let component: B3CommandOptionComponent;
  let hostComponent: TestHostComponent;

  beforeEach(async () => {
    fixture = TestBed.createComponent(TestHostComponent);
    hostComponent = fixture.componentInstance;
    component = fixture.debugElement.query(By.directive(B3CommandOptionComponent)).componentInstance;
