...
@Component({
  ...
  template: `
    <b3-resizable [zLayout]="layout">
      <b3-resizable-panel [zCollapsible]="panel1Collapsible">Panel 1</b3-resizable-panel>
      <b3-resizable-handle [zHandleIndex]="handleIndex" [zWithHandle]="withHandle" [zDisabled]="disabled" [class]="customClass"> </b3-resizable-handle>
      <b3-resizable-panel [zCollapsible]="panel2Collapsible">Panel 2</b3-resizable-panel>
    </b3-resizable>
  `,
})
...
@Component({
  ...
  standalone: true,
  imports: [B3ResizableHandleComponent],
  template: ` <b3-resizable-handle [zHandleIndex]="0" [zWithHandle]="true" [zDisabled]="false"> </b3-resizable-handle> `,
})
class TestStandaloneHandleComponent {}

describe('B3ResizableHandleComponent', () => {
  let fixture: ComponentFixture<TestHandleHostComponent>;
  let hostComponent: TestHandleHostComponent;
  let handleComponent: B3ResizableHandleComponent;
  ...
  beforeEach(async () => {
    ...
    handleComponent = fixture.debugElement.query(By.directive(B3ResizableHandleComponent)).componentInstance;
    handleElement = fixture.debugElement.query(By.directive(B3ResizableHandleComponent)).nativeElement;
  ...
  describe('Component Creation', () => {
    ...
    it('should have exportAs property', () => {
      const debugElement = fixture.debugElement.query(By.directive(B3ResizableHandleComponent));
  ...
  describe('Layout Detection', () => {
    ...
    it('should default to horizontal when no parent resizable', () => {
      ...
      const standaloneElement = standaloneFixture.debugElement.query(By.directive(B3ResizableHandleComponent)).nativeElement;
  ...
  describe('Keyboard Events', () => {
    ...
    it('should not handle keyboard events when no resizable parent', () => {
      ...
      const standaloneHandle = standaloneFixture.debugElement.query(By.directive(B3ResizableHandleComponent)).componentInstance;
      const rightArrowEvent = new KeyboardEvent('keydown', { key: 'ArrowRight', cancelable: true });
  ...
  describe('Default Values', () => {
    let defaultComponent: B3ResizableHandleComponent;

    beforeEach(() => {
      const defaultFixture = TestBed.createComponent(B3ResizableHandleComponent);
