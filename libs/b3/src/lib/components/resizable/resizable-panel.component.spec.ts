...
@Component({
  ...
  standalone: true,
  imports: [B3ResizablePanelComponent],
  template: `
    <b3-resizable-panel [zDefaultSize]="defaultSize" [zMin]="min" [zMax]="max" [zCollapsible]="collapsible" [zResizable]="resizable" [class]="customClass">
...
describe('B3ResizablePanelComponent', () => {
  ...
  beforeEach(async () => {
    ...
    panelComponent = fixture.debugElement.query(By.directive(B3ResizablePanelComponent)).componentInstance;
    panelElement = fixture.debugElement.query(By.directive(B3ResizablePanelComponent)).nativeElement;
  });
  ...
  describe('Component Creation', () => {
    ...
    it('should have exportAs property', () => {
      const debugElement = fixture.debugElement.query(By.directive(B3ResizablePanelComponent));
  ...
  describe('Content Projection', () => {
    ...
    it('should handle complex projected content', () => {
      ...
      const complexPanelElement = complexHostComponent.debugElement.query(By.directive(B3ResizablePanelComponent)).nativeElement;
  ...
  describe('Default Values', () => {
    let defaultComponent: B3ResizablePanelComponent;

    beforeEach(() => {
      const defaultFixture = TestBed.createComponent(B3ResizablePanelComponent);
