...
import { B3ResizableComponent, B3ResizeEvent } from './resizable.component';
...
@Component({
  ...
  template: `
    <b3-resizable [zLayout]="layout" [zLazy]="lazy" (zResizeStart)="onResizeStart($event)" (zResize)="onResize($event)" (zResizeEnd)="onResizeEnd($event)">
      <b3-resizable-panel [zDefaultSize]="defaultSize1" [zMin]="min1" [zMax]="max1" [zCollapsible]="collapsible1"> Panel 1 </b3-resizable-panel>
      <b3-resizable-handle [zHandleIndex]="0" [zWithHandle]="withHandle" [zDisabled]="handleDisabled"></b3-resizable-handle>
      <b3-resizable-panel [zDefaultSize]="defaultSize2" [zMin]="min2" [zMax]="max2" [zCollapsible]="collapsible2"> Panel 2 </b3-resizable-panel>
    </b3-resizable>
  `,
})
class TestResizableHostComponent {
  ...
  resizeStartEvent?: B3ResizeEvent;
  resizeEvent?: B3ResizeEvent;
  resizeEndEvent?: B3ResizeEvent;

  onResizeStart(event: B3ResizeEvent) {
    this.resizeStartEvent = event;
  }

  onResize(event: B3ResizeEvent) {
    this.resizeEvent = event;
  }

  onResizeEnd(event: B3ResizeEvent) {
    this.resizeEndEvent = event;
  }
}

describe('B3ResizableComponent', () => {
  let fixture: ComponentFixture<TestResizableHostComponent>;
  let hostComponent: TestResizableHostComponent;
  let resizableComponent: B3ResizableComponent;
  ...
  beforeEach(async () => {
    ...
    resizableComponent = fixture.debugElement.query(By.directive(B3ResizableComponent)).componentInstance;
    resizableElement = fixture.debugElement.query(By.directive(B3ResizableComponent)).nativeElement;
  });
  ...
  describe('Panel Initialization', () => {
    ...
    it('should handle percentage string default sizes', () => {
      ...
      @Component({
        ...
        template: `
          <b3-resizable>
            <b3-resizable-panel zDefaultSize="60%">Panel 1</b3-resizable-panel>
            <b3-resizable-handle [zHandleIndex]="0"></b3-resizable-handle>
            <b3-resizable-panel zDefaultSize="40%">Panel 2</b3-resizable-panel>
          </b3-resizable>
        `,
      })
      ...
      const percentageResizable = percentageFixture.debugElement.query(By.directive(B3ResizableComponent)).componentInstance;
    ...
    it('should handle pixel string default sizes', () => {
      ...
      @Component({
        ...
        template: `
          <b3-resizable>
            <b3-resizable-panel zDefaultSize="300px">Panel 1</b3-resizable-panel>
            <b3-resizable-handle [zHandleIndex]="0"></b3-resizable-handle>
            <b3-resizable-panel zDefaultSize="200px">Panel 2</b3-resizable-panel>
          </b3-resizable>
        `,
      })
      ...
      const pixelElement = pixelFixture.debugElement.query(By.directive(B3ResizableComponent)).nativeElement;
      Object.defineProperty(pixelElement, 'offsetWidth', { value: 500, configurable: true });

      pixelFixture.detectChanges();

      const pixelResizable = pixelFixture.debugElement.query(By.directive(B3ResizableComponent)).componentInstance;
  ...
  describe('Style Updates', () => {
    it('should update panel styles for horizontal layout', () => {
      ...
      const panels = fixture.debugElement.queryAll(By.directive(B3ResizablePanelComponent));
