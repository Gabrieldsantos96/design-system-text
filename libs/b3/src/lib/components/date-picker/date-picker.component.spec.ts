...
describe('B3DatePickerComponent', () => {
  let component: B3DatePickerComponent;
  let fixture: ComponentFixture<B3DatePickerComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(B3DatePickerComponent);
