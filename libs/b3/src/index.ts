...
// Alert Dialog
export {
  B3AlertDialogComponent,
  B3AlertDialogOptions,
  B3AlertDialogModule,
...
// Dialog
export { B3DialogComponent, B3DialogOptions, B3DialogModule, OnClickCallback as DialogOnClickCallback } from './lib/components/dialog/dialog.component';
