...
This library contains pre-built, production-ready UI blocks for b3-design-system. Each block is a complete Angular component that demonstrates common design patterns and implementations.

## Overview

Blocks are full-page components that showcase real-world use cases, combining multiple b3-design-system components into cohesive layouts. They can be used as starting points for building common application pages like dashboards, authentication flows, e-commerce catalogs, and more.
...
Create your Angular component with the `.component.ts` extension. Use Angular's `ReactiveFormsModule` for form handling and b3-design-system form components for validation:
...
} from '@b3/components/form/form.component';
...
Use b3-design-system form components for proper validation and error handling:
      ...
      <b3-card class="p-4 sm:p-6 lg:p-8">
        <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="space-y-4">
          ...
          <b3-form-field>
            ...
            <b3-form-control [errorMessage]="emailError()">
              <input
                b3-input
                type="email"
          ...
          <b3-form-field>
            ...
            <b3-form-control [errorMessage]="passwordError()">
              <input
                b3-input
                type="password"
          ...
          <b3-button type="submit" class="w-full" [disabled]="isLoading()">
            @if (isLoading()) {
              Signing in...
            } @else {
              Sign in
...
@Component({
  selector: 'b3-my-block',
  standalone: true,
  imports: [B3ButtonComponent, B3CardComponent],
...
export class MyBlockComponent {}`,
  ...
  <b3-card>
    ...
    <b3-button class="mt-4">Get Started</b3-button>
  </b3-card>
</div>`,
      language: 'html',
    },
...
- b3-design-system form components (FormField, FormLabel, FormControl)
...
- **b3-design-system Components**: Base component library
...
- Review the b3-design-system component documentation
